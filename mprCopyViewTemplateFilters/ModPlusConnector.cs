namespace mprCopyViewTemplateFilters
{
    ...
    public class ModPlusConnector : IModPlusFunctionInterface
    {
        ...
        /// <inheritdoc />
        public string LName => "Фильтры шаблонов вида";

        /// <inheritdoc />
        public string Description => "Управление фильтрами шаблонов вида с возможностью копирования фильтров между шаблонами вида с сохранением настроек переопределения графики";
